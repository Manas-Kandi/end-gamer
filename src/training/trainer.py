...
class Trainer:
    ...
    for the chess neural network during self-play training.
    """
    ...
    def get_state_dict(self) -> Dict:
        ...
        Returns:
            Dictionary with optimizer and scheduler state
        """
        return {
    ...
    def load_state_dict(self, state_dict: Dict) -> None:
        ...
        Args:
            state_dict: Dictionary with optimizer and scheduler state
        """
